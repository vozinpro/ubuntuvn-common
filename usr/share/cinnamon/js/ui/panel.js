...
PanelContextMenu.prototype = {
    ...
    _init: function(launcher, orientation, panelId) {
        ...
        menu.troubleshootItem.menu.addAction(_("Change to Windows 10 taskbar style"), function(event) {
            let confirm = new ModalDialog.ConfirmDialog(_("Are you sure you want change to Windows 10 taskbar style?\n\n"),
                    function() {
                        //panels-height=['1:35']
                        Util.spawnCommandLine("gsettings reset-recursively org.cinnamon");
                        Util.spawnCommandLine("gsettings set org.cinnamon.theme name 'Ubuntuvn-windows-style'");
                        Util.spawnCommandLine("gsettings set org.cinnamon panels-height \"['1:35']\"");
                        Util.spawnCommandLine("gsettings set org.cinnamon enabled-applets \"['panel1:left:0:menu@cinnamon.org', 'panel1:left:1:show-desktop@cinnamon.org', 'panel1:left:2:grouped-window-list@cinnamon.org', 'panel1:right:0:systray@cinnamon.org', 'panel1:right:1:xapp-status@cinnamon.org', 'panel1:right:2:notifications@cinnamon.org', 'panel1:right:3:printers@cinnamon.org', 'panel1:right:4:removable-drives@cinnamon.org', 'panel1:right:5:keyboard@cinnamon.org', 'panel1:right:6:network@cinnamon.org', 'panel1:right:7:sound@cinnamon.org', 'panel1:right:8:power@cinnamon.org', 'panel1:right:9:calendar@cinnamon.org']\"");
                        global.reexec_self();
                    });
            confirm.open();
        });
